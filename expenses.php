...
<div style='margin: 0 auto;'>
    <form action="expenses_sender.php" method="POST">
            ...
            <input class="entryField" name="date_expenses" type="date" id="ss_2" required>
            ...
            <p class="miniHeader" id="fd">Категория расхода:</p>
			...
			<button class="regButton" name="add_expenses" type="submit" id="kn_2">Добавить</button>
	</form>
</div>
<?php
