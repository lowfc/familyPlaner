...
<div style='margin: 0 auto;'>
    <form action="category_sender.php" method="POST">
            ...
            <input class="entryField" type="text" name="discription" id='ss' placeholder="Описание категории" required>
            <p class="miniHeader">Класс важности:</p>
            <select name='importance' class="spisok">
			...
			<button class="regButton" name="add_category" id='kn' type="submit">Добавить</button>
	</form>
</div>
<?php
